...
const columns = [
  ...
  { label: "Personne Morale", fieldName: "personne_morale", type: "boolean" },
  { label: "Dénomination", fieldName: "denomination" },
  { label: "Sigle", fieldName: "sigle" },
      ...
      fetchCompanyInfo({ accountId: this.recordId })
        .then((result) => {
          ...
          let companyData = {
            ...
            personne_morale: parsedResult.personne_morale,
            denomination: parsedResult.denomination,
            sigle: parsedResult.sigle,
